...
public class ReflectionUtils {
	...
	public static Field searchFieldByClass(Class<?> clazz, Class<?> searchFor) {
		...
		do {
			...
			for (int b = 0; b < i; b = (byte) (b + 1)) {
				...
				if (!searchFor.isAssignableFrom(field.getType()))
					continue;
		...
		throw new IllegalArgumentException(
				"no " + searchFor.getName() + " field for class " + clazz.getName() + " found");
	}
	...
	public static Object invokeDeclaredMethod(Object o, String methode, Object... objects)
			throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
		Class<?> aClass = o.getClass();
		Method method = (objects.length != 0 ? aClass.getDeclaredMethod(methode, getParametersType(objects))
				: aClass.getDeclaredMethod(methode));
		method.setAccessible(true);
		return method.invoke(o, objects);
	}

	public static Object invokeDeclaredField(Object o, String name)
			throws NoSuchFieldException, IllegalAccessException {
